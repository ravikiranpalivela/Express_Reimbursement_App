...
interface TaskCategoryDao {
    ...
    suspend fun getAllTaskInfo(): List<TaskInfo>

    @Query("SELECT * FROM taskInfo WHERE TaskID = :taskId AND id = :id")
    suspend fun getTaskInfoById(taskId: Int, id: Int): TaskInfo?
