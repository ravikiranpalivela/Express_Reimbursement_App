...
import com.tekskills.er_tekskills.BuildConfig
...
fun showGeofenceInMap(
    ...
    val colorData = when (geofence.locType) {
        "User" -> R.color.black
        "Check_In" -> R.color.blue
        "Check_Out" -> R.color.red
        "Completed" -> R.color.lightgray02
