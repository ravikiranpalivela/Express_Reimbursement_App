package com.tekskills.er_tekskills.presentation.view.multi_spinner;
...
public class MultiSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
    ...
    private int highlightColor = ContextCompat.getColor(getContext(), R.color.colorPrimary);
    ...
    public MultiSpinnerSearch(Context arg0, AttributeSet arg1) {
        ...
        for (int i = 0; i < a.getIndexCount(); ++i) {
            ...
            if (attr == R.styleable.MultiSpinnerSearch_hintText) {
                ...
                highlightColor = a.getColor(attr, ContextCompat.getColor(getContext(), R.color.colorPrimary));
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        ArrayAdapter<String> adapterSpinner = new ArrayAdapter<>(getContext(), R.layout.item_spinner, R.id.tvCountry, new String[]{spinnerText});
    ...
    public void setItems(List<KeyPairBoolData> items, MultiSpinnerListener listener) {
        ...
        ArrayAdapter<String> adapterSpinner = new ArrayAdapter<>(getContext(), R.layout.item_spinner, R.id.tvCountry, new String[]{defaultText});
        setAdapter(adapterSpinner);
    }
