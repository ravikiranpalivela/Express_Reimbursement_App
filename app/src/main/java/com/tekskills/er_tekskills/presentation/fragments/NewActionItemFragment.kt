...
class NewActionItemFragment : Fragment() {
...
//                            requireActivity().finish()
    ...
    private fun showDateTimePicker() {
        ...
        datePicker.addOnPositiveButtonClickListener {
            ...
            binding.dateActionItemDate.text = DateToString.convertDateToStringDateWise(completionDate)
    ...
    private fun isValidate(): Boolean =
        validateClientName() && validateClientContact() && validateClientPosition() && validateActionCompletionDate()

    private fun validateActionCompletionDate(): Boolean {
        if (binding.dateActionItemDate.text.toString() == getString(R.string.edt_action_item_date)) {
            binding.dateActionItemDate.error = "Required Field!"
            binding.dateActionItemDate.requestFocus()
            return false
        } else {
