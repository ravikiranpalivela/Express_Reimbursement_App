...
class NewMOMActionItemFragment : Fragment() {
    private lateinit var binding: FragmentNewMomActionItemBinding
    private lateinit var navController: NavController
    private val args: NewMOMActionItemFragmentArgs by navArgs()
        ...
        binding.fab.setOnClickListener {
            if (isValidate()) {
                viewModel.addMOMActionItem(
                    args.opportunityArg!!.projectId.toString(),args.opportunityArg!!.clientDetails.clientId.toString(),
...
//                && validateClientPosition()
    ...
    private fun validateMeetingDate(): Boolean {
        if (binding.dateMeetingDate.text.toString() == getString(R.string.edt_meeting_date)) {
...
//            binding.dateEscalatedMeetingDate.isErrorEnabled = false
    ...
    private fun validateMeetingTime(): Boolean {
        if (binding.dateMeetingTime.text.toString() == getString(R.string.edt_meeting_time)) {
...
//            binding.dateEscalatedMeetingTime.isErrorEnabled = false
    ...
    private fun showMeetingDatePicker() {
        ...
        datePicker.addOnPositiveButtonClickListener {
            ...
            binding.dateMeetingDate.text = DateToString.convertDateToStringDateWise(meetingDate)
        }
    ...
    private fun showMeetingDateTimePicker() {
        ...
        timePicker.addOnPositiveButtonClickListener {
            ...
            binding.dateMeetingTime.text = DateToString.convertDateToStringDateWise(meetingTime)
        }
        datePicker.show(childFragmentManager, "TAG")
    }
