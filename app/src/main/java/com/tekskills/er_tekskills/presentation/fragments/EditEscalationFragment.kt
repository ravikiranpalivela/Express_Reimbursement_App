...
class EditEscalationFragment : Fragment() {
    ...
    private fun showDateTimePickerRaisedDate() {
        ...
        datePicker.addOnPositiveButtonClickListener {
            ...
            binding.dateEscalatedRaisedDate.text = DateToString.convertDateToString(raisedDate)
    ...
    private fun showDateTimePickerResolvedDate() {
        ...
        datePicker.addOnPositiveButtonClickListener {
            ...
            binding.dateEscalatedResolvedDate.text = DateToString.convertDateToString(resolvedDate)
            timePicker.show(childFragmentManager, "TAG")
        }
    ...
    private fun validateRaisedDate(): Boolean {
        if (binding.dateEscalatedRaisedDate.text.toString() == getString(R.string.escalated_raised_date)) {
...
//            binding.dateEscalatedRaisedDate.isErrorEnabled = false
    ...
    private fun validateResolvedDate(): Boolean {
        if (binding.dateEscalatedResolvedDate.text.toString() == getString(R.string.escalated_resolved_date)) {
